...
#
# Generated by export_simulation on Wed Jun 13 17:40:54 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './vp_switch_final_0.sh' script.

./vp_switch_final_0.sh -reset_run
...
./vp_switch_final_0.sh -noclean_files

For more information on the script, please type './vp_switch_final_0.sh -help'.
