...
HD_PWD='C:/Users/GaliTingus/Documents/SR_Project/tor_test_new/tor_test_new.runs/vp_switch_final_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vp_switch_final_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vp_switch_final_0.tcl
