...
#
# Generated by export_simulation on Wed May 23 00:55:49 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './vp_switch_0.sh' script.

./vp_switch_0.sh -reset_run
...
./vp_switch_0.sh -noclean_files

For more information on the script, please type './vp_switch_0.sh -help'.
