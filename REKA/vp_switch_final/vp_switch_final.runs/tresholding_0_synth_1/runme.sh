...
HD_PWD='C:/Users/GaliTingus/Documents/SR_Project/REKA/vp_switch_final/vp_switch_final.runs/tresholding_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tresholding_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tresholding_0.tcl
