...
#
# Generated by export_simulation on Wed May 23 00:52:45 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './tresholding_0.sh' script.

./tresholding_0.sh -reset_run
...
./tresholding_0.sh -noclean_files

For more information on the script, please type './tresholding_0.sh -help'.
