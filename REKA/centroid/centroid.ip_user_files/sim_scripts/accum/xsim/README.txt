...
#
# Generated by export_simulation on Wed Jun 06 13:20:11 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './accum.sh' script.
...
./accum.sh -noclean_files

For more information on the script, please type './accum.sh -help'.
