...
HD_PWD='C:/Users/GaliTingus/Documents/SR_Project/REKA/centroid/centroid.runs/accum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accum.tcl
