...
proc create_root_design { parentCell } {
  ...
  # Create instance: vp_switch_final_0, and set properties
  set vp_switch_final_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:vp_switch_final:1.0 vp_switch_final_0 ]
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins vp_switch_final_0/clk]
  connect_bd_net -net dvi2rgb_0_vid_pData [get_bd_pins dvi2rgb_0/vid_pData] [get_bd_pins vp_switch_final_0/pixel_in]
  connect_bd_net -net dvi2rgb_0_vid_pHSync [get_bd_pins dvi2rgb_0/vid_pHSync] [get_bd_pins vp_switch_final_0/h_sync_in]
  connect_bd_net -net dvi2rgb_0_vid_pVDE [get_bd_pins dvi2rgb_0/vid_pVDE] [get_bd_pins vp_switch_final_0/de_in]
  connect_bd_net -net dvi2rgb_0_vid_pVSync [get_bd_pins dvi2rgb_0/vid_pVSync] [get_bd_pins vp_switch_final_0/v_sync_in]
  ...
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins vp_switch_final_0/SW]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net vp_switch_final_0_de_out [get_bd_pins rgb2vga_0/rgb_pVDE] [get_bd_pins vp_switch_final_0/de_out]
  connect_bd_net -net vp_switch_final_0_h_sync_out [get_bd_pins rgb2vga_0/rgb_pHSync] [get_bd_pins vp_switch_final_0/h_sync_out]
  connect_bd_net -net vp_switch_final_0_pixel_out [get_bd_pins rgb2vga_0/rgb_pData] [get_bd_pins vp_switch_final_0/pixel_out]
  connect_bd_net -net vp_switch_final_0_v_sync_out [get_bd_pins rgb2vga_0/rgb_pVSync] [get_bd_pins vp_switch_final_0/v_sync_out]
