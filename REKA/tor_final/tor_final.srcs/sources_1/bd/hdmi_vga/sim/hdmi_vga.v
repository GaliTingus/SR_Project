...
module hdmi_vga
  ...
  wire [2:0]sw_1;
  wire sys_clock_1;
  wire vp_switch_final_0_de_out;
  wire vp_switch_final_0_h_sync_out;
  wire [23:0]vp_switch_final_0_pixel_out;
  wire vp_switch_final_0_v_sync_out;
  ...
  hdmi_vga_rgb2vga_0_0 rgb2vga_0
       (.PixelClk(dvi2rgb_0_PixelClk),
        .rgb_pData(vp_switch_final_0_pixel_out),
        .rgb_pHSync(vp_switch_final_0_h_sync_out),
        .rgb_pVDE(vp_switch_final_0_de_out),
        .rgb_pVSync(vp_switch_final_0_v_sync_out),
  ...
  hdmi_vga_vp_switch_final_0_0 vp_switch_final_0
       (.SW(sw_1),
        .clk(dvi2rgb_0_PixelClk),
        .de_in(dvi2rgb_0_vid_pVDE),
        .de_out(vp_switch_final_0_de_out),
        .h_sync_in(dvi2rgb_0_vid_pHSync),
        .h_sync_out(vp_switch_final_0_h_sync_out),
        .pixel_in(dvi2rgb_0_vid_pData),
        .pixel_out(vp_switch_final_0_pixel_out),
        .v_sync_in(dvi2rgb_0_vid_pVSync),
        .v_sync_out(vp_switch_final_0_v_sync_out));
endmodule
