...
HD_PWD='C:/Users/GaliTingus/Documents/SR_Project/REKA/tor/tor.runs/hdmi_vga_vp_switch_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_vga_vp_switch_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_vga_vp_switch_0_0.tcl
